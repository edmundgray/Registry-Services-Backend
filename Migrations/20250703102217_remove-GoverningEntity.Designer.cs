...
namespace RegistryServices.Migrations
{
    ...
    [Migration("20250703102217_remove-GoverningEntity")]
    partial class removeGoverningEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RegistryApi.Models.ExtensionComponentModelElement", b =>
                {
                    ...
                    b.Property<string>("ConformanceType")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("UsageNoteCore")
                        .HasColumnType("text");

                    b.Property<string>("UsageNoteExtension")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("RegistryApi.Models.SpecificationIdentifyingInformation", b =>
                {
                    ...
                    b.Property<string>("ConformanceLevel")
                        .HasMaxLength(25)
